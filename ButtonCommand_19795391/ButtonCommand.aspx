<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ButtonCommand.aspx.cs" Inherits="ButtonCommand_19795391.ButtonCommand" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br /><br />
            <asp:Button runat="server" CommandArgument="Adidas" CommandName="View" OnCommand="Button_Command" Text="Adidas" OnClick="Unnamed2_Click" />
